...
export const mockGallery: GalleryItem[] = [
  {
    ...
    imageSrc: "/images/nails/nails1.jpg",
  },
  {
    id: "golden-almond",
    title: "Golden Almond Glow",
    category: "Nail Extensions",
    style: "Gloss Finish",
    color: "Soft Gold",
    description: "Elegant almond extensions with a luminous sheen and softly sculpted length.",
    imageSrc: "/images/nails/EuroSummerPDP_SunsetTide_1.webp",
  },
  {
    id: "milk-french",
    title: "Milky French",
    ...
    imageSrc: "/images/nails/71knunTGLcL._AC_UF1000,1000_QL80_.jpg",
  },
  {
    id: "soft-satin-mani",
    title: "Soft Satin Manicure",
    category: "Manicure",
    style: "Minimal Shine",
    color: "Pearl Nude",
    description: "A polished everyday manicure with a clean satin finish and understated shine.",
    imageSrc: "/images/nails/images.jpeg",
  },
  {
    id: "gold-swirl",
    ...
    imageSrc: "/images/nails/Untitleddesign3-f4cd8e3e8ee44c41aa930cc76109a52f.png",
  },
  {
    id: "luxe-accent-detail",
    title: "Luxe Accent Detail",
    category: "Add Ons",
    style: "Accent Art",
    color: "Champagne Blush",
    description: "A refined add-on detail that lifts a simple set with a little extra personality.",
    imageSrc: "/images/nails/ChatGPT-Image-Apr-25-2026-11_15_13-PM-1.png",
  },
  {
    id: "mocha-glaze",
    title: "Mocha Glaze",
    ...
    imageSrc: "/images/nails/il_fullxfull.6294184478_mkuh.avif",
  },
  {
    id: "sunset-pedi-shine",
    title: "Sunset Pedi Shine",
    category: "Pedicure",
    style: "High Gloss",
    color: "Rosy Bronze",
    description: "A glossy pedicure look with warm tones designed to feel fresh, smooth, and radiant.",
    imageSrc: "/images/nails/EuroSummerPDP_SunsetTide_1.webp",
  },
  {
    id: "soft-floral",
    ...
    imageSrc: "/images/nails/12._Chocolate_Metallic_Cat-Eye_Long_Nails_-_Nail_Ideas_For_Long_Nails_2048x.progressive.webp",
  },
  {
    id: "complete-glam-pairing",
    title: "Complete Glam Pairing",
    category: "Combo Services",
    style: "Signature Pairing",
    color: "Warm Nude",
    description: "A coordinated manicure and pedicure pairing for guests who want a full polished refresh.",
    imageSrc: "/images/nails/12._Chocolate_Metallic_Cat-Eye_Long_Nails_-_Nail_Ideas_For_Long_Nails_2048x.progressive (1).webp",
  },
  {
    id: "midnight-cat-eye",
  ...
  {
    id: "mini-sparkle-finish",
    title: "Mini Sparkle Finish",
    category: "Kids 12 And Under",
    style: "Playful Gloss",
    color: "Candy Pink",
    description: "A fun, bright look with a soft sparkle that works beautifully for younger guests.",
    imageSrc: "/images/nails/ChatGPT-Image-Apr-25-2026-11_15_13-PM-1.png",
  },
  {
    id: "soft-wax-finish",
    ...
    style: "Clean Finish",
    color: "Soft Neutral",
    description: "A polished, clean beauty result that suits waxing and detail-focused appointments.",
    imageSrc: "/images/nails/71knunTGLcL._AC_UF1000,1000_QL80_.jpg",
  },
  {
    id: "smooth-finish-detail",
    title: "Smooth Finish Detail",
    category: "Waxing",
    style: "Fresh Finish",
    color: "Natural Glow",
    description: "A clean finish reference that reflects the smooth, tidy result guests want from waxing services.",
    imageSrc: "/images/nails/images.jpeg",
  },
  {
    id: "reset-and-refresh",
    title: "Reset And Refresh",
    category: "Take Off",
    style: "Fresh Start",
    color: "Natural",
    description: "A clean reset look that pairs well with removal services before your next full set.",
    imageSrc: "/images/nails/Untitleddesign3-f4cd8e3e8ee44c41aa930cc76109a52f.png",
  },
  {
    id: "bare-beauty-reset",
    title: "Bare Beauty Reset",
    category: "Take Off",
    style: "Clean Reset",
    color: "Natural Nude",
    description: "A fresh, stripped-back finish that suits take-off appointments and a clean start.",
    imageSrc: "/images/nails/gelnailextensions-45a0e3af9df84984bcc5d8b5baa9ed30_e94baae9-9108-4d91-87a8-bd891e6ac451.webp",
  },
];
